<template>
  <div id="myRaceVote">
    <div class="header-title">
      <mt-header title="我的赛事订单" :style="{background:'#1965b5'}">
    ...
    <div class="raceList-w bs">
      <ul class="raceList-content">
        <li class="list-item clear" v-if="userInfo.userRaceVoteList" v-for="race in userInfo.userRaceVoteList" :key="race.race_id" @click="goDetial(race.race_id)">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      $(window).scrollTop(0);
      if(this.userInfo.userRaceVoteList.length <= 0){
        this.getUserInfo();
      }
    }
  }
